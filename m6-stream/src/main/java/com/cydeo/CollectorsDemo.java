...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        //toMap(Function,Function) : returns a Collector interface that gathers that gathers the input data into a new map
        ...
        Double clorieAverage = DishData.getAll().stream()
                .collect(Collectors.averagingInt(Dish::getCalories));

        System.out.println(clorieAverage);
        ...
        //partitioningBy(); is used to partition a stream of objects (or a set of elemets) based on a given predicate
